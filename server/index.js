...
app.get('/views/myRoutes', authenticateToken, async (req, res) => {
  try {
    const result = await prisma.$queryRaw`
...
app.get('/views/routesHistoryDriver', authenticateToken, async (req, res) => {
  try {
    const result = await prisma.$queryRaw`
    SELECT * FROM route_history 
...
app.get('/views/routesHistoryUser', authenticateToken, async (req, res) => {
  try {
    const result = await prisma.$queryRaw`
    SELECT * FROM route_history 
